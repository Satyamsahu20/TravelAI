...
# ⚠️ Replace with your real local paths
VENV_PYTHON = r"C:\Users\Hp\OneDrive\Desktop\TravelAI\.venv\Scripts\python.exe"
PROJECT_DIR = r"C:\Users\Hp\OneDrive\Desktop\TravelAI"
...
client = MultiServerMCPClient(
    {
        ...
        "flight": {
            "transport": "stdio",
            "command": VENV_PYTHON,
            "args": [f"{PROJECT_DIR}\\mcp_servers\\flight_mcp_server.py"],
            "env": {
        ...
        "weather": {
            "transport": "stdio",
            "command": VENV_PYTHON,
            "args": [f"{PROJECT_DIR}\\mcp_servers\\weather_mcp_server.py"],
            "env": {
